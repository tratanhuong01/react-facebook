...
export default function NotImageVideoPreview() {
    ...
    return (
        <>
            <div className='w-full h-56 bg-gray-100 hover:bg-gray-200 flex items-center justify-center'>
                <label htmlFor='inputFileUpload'>
                    ...
                    <p className='text-xl py-0.5 text-center'>Thêm ảnh/video</p>
                    <p className='text-xs text-gray-500 text-center'>hoặc kéo , thả</p>
                </label>
            </div>
            <div className='my-2 w-full p-1.5 flex relative items-center'>
                ...
                <p className='text-sm ml-2 pr-14 pl-3'>{transport ? 'Hãy nhấn vào thông báo trên thiết bị di động để thêm ảnh.' :
