    ...
    return (
        <div className=''>
            ...
            <div className='w-full flex justify-center my-3'>
                <textarea className='w-full mx-auto h-20 p-3 border border-solid border-gray-200 shadow-lv1 
                     rounded-lg resize-none focus:border-blue-500' spellCheck={false} placeholder='Chú thích'></textarea>
            </div>
        </div>
    )
}
