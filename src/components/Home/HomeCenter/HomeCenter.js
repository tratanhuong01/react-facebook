    ...
    return (
        <div className="center-content relative left-0 px-2 sm:w-full sm:mx-auto md:w-3/4 lg:mx-0 
            ...
            <div className="flex my-4 relative gap-1">
                <div className="flex-shrink-0 w-1/4 md:w-1/6 px-1 pl-0 relative text-center h-44 cursor-pointer">
                ...
                <ItemStory last={true} />
                <div className="w-10 h-10 absolute top-1/2 transform -translate-y-1/2 -mt-1 -right-4 rounded-full dark:bg-dark-third 
