...
const PopoverHeaderRightWrapper = (props, ref) => {
    return (
        ...
        z-50 top-full mt-2 right-5 wrapper-scrollbar overflow-x-hidden overflow-y-auto border-solid border-gray-200 
        lg:w-92 lg:p-0 sm:w-3/4 border-2 lg:w-92 shadow-lv1 dark:border-dark-main`} style={{
